...
export default function CreateResume() {
  ...
  const [genCont, setGenCont] = useState(
    <>
      <img
        ...
        src="./images/wand-magic-sparkles-solid.svg"
        alt=""
      />
      ...
      messages: [
        {
          role: "system",
          content:
            "Summarize content you are provided to a about section in a resume so i  will start like the user talking about himself freely like an about me section without pricising this is an about me section, limit to 150 words",
        },
        {
          role: "user",
  ...
  return (
    <section className={styles.container}>
      ...
      <div className={styles.resumeForm}>
        <div className={styles.headerContainer}>
          <span className={styles.stepIcon}>3</span> <h2>Add Your Education</h2>
        </div>
        <form action="">
      ...
      <div className={styles.resumeForm}>
        <div className={styles.headerContainer}>
          <span className={styles.stepIcon}>4</span> <h2>Add Your Skills</h2>
        </div>
